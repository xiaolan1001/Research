...
# /home/summer/research/cudd-release/nanotrav/.libs/nanotrav -p 1 -ordering dfs -reordering cogroup -drop -char2vect -cofest ./nanotrav/adj49.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  8012K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1447
Swaps = 0
Input blocks = 0
Output blocks = 8
