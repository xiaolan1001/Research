...
# /home/summer/research/cudd-release/nanotrav/.libs/nanotrav -p 1 -ordering dfs -autodyn -automethod sifting -reordering sifting -drop ./nanotrav/C880.blif
# CUDD Version 3.0.0
...
Number of cache collisions: 2501
Number of cache deletions: 28104
Cache used slots = 18.11% (expected 0.00%)
Soft limit for cache size: 62464
Number of buckets in unique table: 15616
Used buckets in unique table: 21.16% (expected 20.96%)
...
Maximum resident size            =  7476K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1998
Swaps = 0
Input blocks = 0
Output blocks = 8
