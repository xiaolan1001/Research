...
# /home/summer/research/cudd-release/nanotrav/.libs/nanotrav -p 1 -trav -image depend -depend ./nanotrav/s27c.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  7424K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1278
Swaps = 0
Input blocks = 0
Output blocks = 8
